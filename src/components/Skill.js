...
const Skills = () => {
  const [squares, setSquares] = useState(["HTML", "CSS", "Javascript", "TailwindCSS", "ChakraUI", "Bootstrap", "React", "Figma", "Git", "Photoshop"]);
  ...
  return (
    <div class="flex-grow border-t-4 border-[#362B44]">
      <div className="min-h-max md:flex items-center justify-center md:p-32 px-8 py-20 bg-[#F5CBA7]">
        <div className="md:grid md:gap-10">
          <p className="text-[#FF491F] pb-10 md:text-7xl text-4xl font-semibold tracking-wide font-lemon-reg md:font-outline-4 font-outline-2">
            Skills & Experiences
          </p>
        ...
        <div className="text-[#503B40] font-['Cabin'] md:grid md:grid-rows-2 md:gap-3 md:mx-16">
          ...
          <p className="lg:text-justify lg:text-xl font-medium text-justify">
            I've created a website with a number of front-end development frameworks, including React, TailwindCSS, and Bootstrap. Also, i usually create my own
            design UI or graphic by using Photoshop and Figma application
          </p>
          ...
          <div>
            ...
            <p className="lg:text-justify lg:text-xl font-medium text-justify mb-2">
              I've experienced in graphic design and developed a variety of website as front-end. Below is my experience about my skill
            </p>
            {exp.map((experiences) => (
