...
const About = () => {
  return (
    <div className="flex-grow border-t-4 border-[#362B44]">
      <div className="min-h-max m-auto md:flex items-center justify-center md:p-32 px-8 py-20 bg-[#E2DBD1]">
        ...
        <div className="text-[#503B40] font-['Cabin'] grid md:grid-rows-2 grid-rows-1 gap-2">
          ...
          <div className="md:flex gap-8">
            <div className="flex gap-2">
              ...
              Arlynandhita Felisya
            </div>
            <div className="flex gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="w-5 h-5">
                <path
                  fill="#362B44"
